            ...
            <div class="mx-10">
                <table class="table bg-white">
                    ...
                    @foreach($documents as $document)
                            <tr>
                                <td><a class="text-blue-600 hover:underline " href="{{url('client/documents/'.$document->id)}}">{{$document->document_name}}</a></td>
        ...
        function proposalTab() {
            return {
                ...
                deleteDocument(document_id) {
                    fetch("{{ url('api/v1/clients/documents') }}/" + document_id, {
                        method: "DELETE",
                        headers: {
